...
def pelican_optimization_algorithm(pop_size, dim, bounds, max_iter):
    ...
    for iteration in range(max_iter):
        ...
        bsol.append(best_solution)
        bf.append(best_fitness)
        
    return bsol, bf, iters
...
# Run the algorithm
best_solution, best_fitness, iterations = pelican_optimization_algorithm(pop_size, dim, bounds, max_iter)
print(f"Best Solution: {best_solution}, Best Fitness: {best_fitness}")
plot_func(iterations, best_solution)
